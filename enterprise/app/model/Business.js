Ext.define('SP.model.Business', {
	...
	proxy: {
	    ...
	    api : {
	         read: SP.GlobalConfig.getBaseUrl() + '/platform/admin?actid=1076',
	         create:  SP.GlobalConfig.getBaseUrl() + '/platform/admin?actid=1072',
	         update: SP.GlobalConfig.getBaseUrl() + '/platform/admin?actid=1073',
	         destroy: ''
	    },
	    reader: {
	        type: 'xml',
