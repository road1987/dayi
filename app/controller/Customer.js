Ext.define('SP.controller.Customer', {
        ...
        this.control({
           ...
           "customeredit treecombo[name=market]" : {
         		...
         		change : function(comp){
         			...
         			serviceProviderStore.getProxy().api.read = "platform/admin?actid=1077";
    ...
    queryCustomerByKeyword : function(comp){
    	...
    	store.getProxy().api.read = "platform/admin?actid=1086";
    ...
    queryCustomerByComplex : function(comp){
    	...
    	var grid = this.getCustomerListGrid();	
    	var store = grid.getStore();
    	store.getProxy().api.read = "platform/admin?actid=1087";
    	store.getProxy().extraParams = {
    		"treetype" : treeType,
